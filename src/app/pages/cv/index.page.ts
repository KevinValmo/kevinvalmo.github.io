    ...
    <div class="mt-6 flex flex-col gap-2 text-justify">
      ...
      <div>
        ...
        <div class="mt-2">
          ...
          <label class="text-hl">front-end development</label>, specializing in
          <label class="text-hl">SQL databases</label> and
          ...
          skills help me engage with clients and manage projects effectively. I
          also write knowledge posts on my tech stack (C#, .NET, TypeScript,
        ...
        <div class="flex flex-col gap-4 mt-4">
          <div class="pb-4 border-b-4 border-dotted">
            ...
            <ul class="list-disc mt-4 pl-5 ">
              <li>
                ...
                <label class="text-hl"> enhancements for live projects </label>
                while supporting the team.
              </li>

              <li>
                Ensured optimal performance, troubleshooting, and alignment with
                business goals in
                <label class="text-hl">
          ...
          <div class="pb-4 border-b-4 border-dotted">
            <div class="flex justify-between flex-wrap gap-2">
              ...
              <div class="flex-1 text-end">
                <div class="text-sm">
                  <a href="https://www.qualitas.it/"> Qualitas Informarica </a>
                </div>
            ...
            <ul class="list-disc mt-4 pl-5 ">
              <li>
                ...
                database integration, real-time signals, and communication with
                proprietary or standard external environments.
              </li>
              <li>
          ...
          <div class="pb-4 border-b-4 border-dotted">
            ...
            <ul class="list-disc mt-4 pl-5 ">
              ...
              <li>
                ...
                and Blazor, with the use of external and ad hoc components, with
                <label class="text-hl">real time</label> information exchange.
              </li>
              <li>
          ...
          <div>
            ...
            <ul class="list-disc mt-4 pl-5 ">
              ...
              <li>
                <label class="text-hl">SQL database management </label> and and
                intermediate complexity querying.
              </li>
            </ul>
          </div>
        </div>
